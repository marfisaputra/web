...
class M_post extends CI_Model {
    ...
    function get_list($cari = null,$offset=0,$row_per_page=5 ) {
        $sql    = "SELECT id_post,id_post_kat,kd,nm,isi,gambar,tgl_publish,is_publish FROM ".$this->tablename;
        $where  = "";
    ...
    function get_data($id) { // menampilkan data page
        $sql = "SELECT id_post,id_post_kat,kd,nm,isi,gambar,tgl_publish,is_publish FROM ".$this->tablename. ' WHERE '.$this->key.' = ?';
        $data[$this->key] = $id;
    ...
    function create($data) { // membuat create post kategori
    ...
    function update($data, $id) { //mengubah post kategori
        $key[$this->key] = $id;
    ...
    function delete($id) { //menghapus post kategori
        $key[$this->key] = $id;
