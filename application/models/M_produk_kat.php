...
class M_produk_kat extends CI_Model {
    //put your code here
    var $tablename = "tb_prod_kat";
    var $key = "id_prod_kat";
    ...
    function tampil_list() {
        $sql = "SELECT id_prod_kat,kd,nm,par,ket FROM ".$this->tablename;
    ...
    function get_data($id) { // menampilkan data produk kategori
        $sql = "SELECT id_prod_kat,kd,nm,par,ket FROM ".$this->tablename. ' WHERE '.$this->key.' = ?';
        $data[$this->key] = $id;
    ...
    function create($data) { // membuat create post produk kategori
    ...
    function update($data, $id) { //mengubah post produk kategori
        $key[$this->key] = $id;
