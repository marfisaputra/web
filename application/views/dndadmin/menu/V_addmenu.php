          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method='post' action="<?php echo site_url("menu/tambah") ?>">
              <table class='table table-bordered'>
                ...
                <tr>
                  ...
                  <td>
                    <select class="input-xlarge" name="page" class='form-control'>
                      ...
                      <option value="<?php echo $pg->id_page?>"><?php echo $pg->nm?>
                      <?php } ?>  
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  <td>Seq</td>
                  <td><input type='text' name='seq' class='form-control' required></td>
                </tr>
